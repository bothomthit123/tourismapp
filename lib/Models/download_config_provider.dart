...
class DownloadConfigurationProvider extends ChangeNotifier {
  ...
  bool get enableBrowsingCache => _enableBrowsingCache;

  void toggleBrowsingCache(bool isEnabled) {
    _enableBrowsingCache = isEnabled;
    notifyListeners(); // Thông báo cho map_page build lại
  }
// ===================================================
}