...
class RegionSelectionProvider extends ChangeNotifier {
  // [SỬA] Thêm check !kIsWeb lên đầu
  // Nếu là Web -> kIsWeb = true -> !kIsWeb = false -> Dừng lại, trả về vế sau (usePointer)
  // Nếu là Mobile -> kIsWeb = false -> !kIsWeb = true -> Chạy tiếp kiểm tra Platform
  ...
  set isDownloadSetupPanelVisible(bool newState) {
    // [GỢI Ý] Nếu muốn chặn không cho hiện bảng Download trên Web thì thêm dòng này:
    // if (kIsWeb) return;
